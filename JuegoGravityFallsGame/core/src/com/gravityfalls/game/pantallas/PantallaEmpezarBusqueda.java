...
public class PantallaEmpezarBusqueda implements Screen {
	...
	public void show() {
        //(mientras no funcione el mapa)
		 entradasSalidas = new EntradasSalidas(this);
	        ...
	        // Configura la cámara centrada en el mapa
	        gameCam.position.set(map.getProperties().get("width", Integer.class) * 16 / 2,
	                map.getProperties().get("height", Integer.class) * 16 / 2, 0);
	        gameCam.update();
	...
	public void render(float delta) {
		...
		//solo para abrir pantalla "Level Up" y/0 "Game Over" (mientras no funcione el mapa)
		if (entradasSalidas.isEnter()) {
